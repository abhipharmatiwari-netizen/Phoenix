...
MODULE_PATH = "app.brokers.base"
CALLABLE_NAMES = ['OrderSide', 'OrderType', 'ProductType', 'TimeInForce', 'OrderPurpose', 'OrderRequest', 'OrderResponse', 'Position', 'Balance', 'BrokerClient']

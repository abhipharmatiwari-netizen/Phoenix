...
Last verified against the VM: 2026-06-06 10:29 UTC.
...
| Backend container | `phoenix-oci-backend`, image `phoenix-local-backend:local-4f567bf`, healthy |

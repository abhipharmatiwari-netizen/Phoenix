...
- 2026-06-06 frontend static asset redeploy moved the main VM checkout to
  `4f567bf` and nginx to `local-4f567bf`; the backend container stayed on the
  prior `local-c8c80ea` image. The sidecar image remains

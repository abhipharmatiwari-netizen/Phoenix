...
| Dry-run spread risk | `OI_ML_SHADOW_SPREAD_WIDTH_POINTS` controls spread width; `OI_ML_SHADOW_MAX_SPREAD_LOSS_RUPEES` controls the shadow guard's spread loss cap |

...
- backend image: `phoenix-local-backend:local-4f567bf`
...
- backend image is `phoenix-local-backend:local-4f567bf` in the latest
  verified deployment
...
| Drift | Evidence | Risk |
|---|---|---|
| Local images instead of OCIR | `phoenix-local-backend:local-4f567bf`, `phoenix-local-nginx:local-4f567bf` verified on 2026-06-06 | Old OCIR docs do not describe current deploy/restart behavior |
